            ...
            <div class="row">
                    ...
                    <div class="box-category">
                        <ul id="cat_accordion">
                            @foreach($categories as $category)
                                <li><a href="category.html">{{$category->title}}</a> <span class="down"></span>
                                    <ul>
                ...
                <div id="content" class="col-sm-9">
                    ...
                    <div class="slideshow single-slider owl-carousel">
                        @foreach($sliders as $slide)
                            <div class="item"><a href="{{$slide->link}}">
                                    <img class="img-responsive"
                                         src="{{str_replace('public' ,'/storage',$slide->image)}}" height="100"
                    ...
                    <div class="category-module" id="latest_category">
                        <h3 class="subtitle">{{$featuredCategory->title}} - <a class="viewall" href="category.tpl">نمایش
                                همه</a></h3>
                                                ...
                                                <div class="caption">
                                                    ...
                                                    <p class="price">
                                                        ...
                                                        @if($product->has_discount)
                                                            <span class="price-old">{{$product->cost_with_discount}} تومان</span>
                ...
                @foreach($categories as $category)
                    <!-- دسته ها محصولات Slider Start -->
                        <h3 class="subtitle">
                            {{$category->title}}
                            <a class="viewall" href="#">نمایش همه</a></h3>
                                ...
                                <div class="product-thumb">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p class="price">
                                            ...
                                            {{--===================                                            معادل اند==========--}}
                                            @if($product->has_discount)
                                                <span class="price-old">{{$product->cost}} تومان</span> <span
                                                    class="saving">-{{$product->discount_value}}%</span>
                                            @endif
                                        </p>
